...
<tr class="comment-row <?php if ($this->comment->state == Comment::STATE_UNAPPROVED) echo 'unapproved' ?>">
	...
	<td class="comment">
		<div class="created">
			...
			<?php endif; ?>
			<?php echo JHTML::_('date', $this->comment->created, JText::_('DATE_FORMAT_LC2')); ?>
		</div>
		<p><?php echo CommentHelper::filterContentOutput($this->comment->content); ?></p>
	...
	<td class="comment-on">
		...
		<?php $link = JRoute::_($this->link_base.'&controller=item&task=edit&cid[]='.$item->id); ?>
