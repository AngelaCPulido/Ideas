...
class ElementRating extends Element {
	...
	*/
	public function edit() {
		...
		if ($this->_data->get('votes', 0)) {
			...
			// create js
			$javascript  = "var rating = new Zoo.ElementRating('".$this->identifier."', '".JRoute::_('index.php?option='.$option.'&controller='.$controller.'&format=raw&type='.$this->getType()->identifier.'&elm_id='.$this->identifier.'&item_id='.$this->getItem()->id, false)."');";
	...
	*/
	public function loadAssets() {
		JHTML::script('rating.js', 'administrator/components/com_zoo/elements/rating/');
