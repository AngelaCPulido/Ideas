...
/* bubble styling */
include(PATH_ROOT . 'styles/bubble/style.css');

if ($is_ie6 && !$is_ie7) include(PATH_ROOT . 'styles/bubble/ie6hacks.css');
if ($is_ie6 || $is_ie7) include(PATH_ROOT . 'styles/bubble/iehacks.css');
