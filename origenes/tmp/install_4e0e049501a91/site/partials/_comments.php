...
if ($params->get('facebook_enable')) :
	...
	$document->addScriptDeclaration("window.addEvent('domready', function(){\nFB.init('".$params->get('facebook_api_key')."', '".ZOO_ADMIN_URI."libraries/facebook/xd_receiver.php');\n});");
endif;
...
<script type="text/javascript">
	var comments_app = new Zoo.Comment({ cookiePrefix: '<?php echo CommentHelper::COOKIE_PREFIX; ?>', cookieLifetime: '<?php echo CommentHelper::COOKIE_LIFETIME; ?>' });
</script>