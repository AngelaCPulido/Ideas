...
class Application extends YObject {
	...
	*/
	...
	/*
	   ...
	   Returns:
	      Array - Categories
 	*/
	public function getCategories($published = false) {

		// get categories
		if (empty($this->_categories)) {
			$this->_categories = YTable::getInstance('category')->getAll($this->id);
		}
	...
	/*
	   ...
	   Returns:
	      Array - Categories
 	*/
	public function getCategoryTree($published = false, $user = null) {

		// get category tree
		if (empty($this->_category_tree)) {
			// get categories and item count
			$categories = $this->getCategories($published);
			$item_count = CategoryHelper::getCategoryItemCount($user);
			
			$this->_category_tree = CategoryHelper::buildTree($this->id, $categories, $item_count);
		}
	...
	*/
	...
	/*
		Function: getType
			Retrieve application type by alias.
